...
import { deleteMaintenanceImage, deleteProgress, getReservationDetail, postProgress } from "../api/ReservationApi";
...
export default function ReservationDetail() {
    ...
    <>
        ...
        <AddImageModal reservationId={reservationId} status={modalStatus} onPost={showAddedImage} onClose={closeModal} visible={modalVisible} />
    </>
    );
  }
