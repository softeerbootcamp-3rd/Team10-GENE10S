  ...
  return (
    <div className={classNames('step')}>
      ...
      <div className={classNames('category')}>
        <div className={classNames('text')}>진행 단계</div>
      </div>
      {/* step-detail */}
          ...
          {progressStage.map((stage, index) => (
            ...
            >
              <div className={classNames('icon')}>
                <svg
                  className={classNames('ellipse-2')}
                ...
                >
                  <circle
                    ...
                    cy="30"
                    r="28.25"
                    stroke={index < progressStage.length - 1 ? '#B6B0A8' : '#F3AB39'}
                    strokeWidth="3.5"
                  />
                </svg>
                <svg
                  className={classNames('ellipse-3')}
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="25"
                  viewBox="0 0 25 25"
                ...
                >
                  <path
                    ...
                    fill={index < progressStage.length - 1 ? '#B6B0A8' : '#CF8D26'}
                  />
                </svg>
                {index !== progressStage.length - 1 && (
                  <svg
                    className={classNames('line-9')}
                    xmlns="http://www.w3.org/2000/svg"
                    width="4"
                    height="101"
                    viewBox="0 0 4 101"
                  ...
                  >
                    <path
                      d="M2 0L2 101"
                      stroke={index < progressStage.length - 2 ? '#B6B0A8' : '#F3AB39'}
                      strokeWidth="3.5"
                      strokeDasharray="4 4"
                    />
                  </svg>
              ...
              <div className={classNames('text')}>
                <div className={classNames('text-1')}>{stage.date}</div>
                <div className={classNames('text-2')}>{stage.step}</div>
                {index !== 0 && stage.detail && (
                  <div className={classNames('detail')}>
                    <div className={classNames('text-1')}>세부 사항</div>
                    <div className={classNames('text-2')}>{stage.detail}</div>
                  </div>
                )}
              </div>
            </div>
