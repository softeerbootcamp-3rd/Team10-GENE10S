    ...
    <div className={classNames('reserv-intro-page')}>
      ...
      <div className={classNames('main-board')}>
        ...
        <div className={classNames('title-fixed')}>
          <div className={classNames('title-text')}>Reservation</div>
        </div>
      </div>
      ...
      <div className={classNames('info-area')}>
        <div className={classNames('service-info')}>
          <h3 className={classNames('title')}>에어포트 서비스</h3>
        ...
        <AnimatedComponent name="animation-3" delay={0.15} duration={2} yDuration={2} translateY={50}>
          <div className={classNames('type-info')}>
            <div className={classNames('image-frame-1')} />
            <div className={classNames('text-frame')}>
              <h3 className={classNames('txt-title')}>김포 에어포트 서비스</h3>
              ...
              <div className={classNames('text-content')}>
                <p className="txt-info">{getContentByButton(selectedButtonKimpo)}</p>
              </div>
            </div>
          </div>
        </AnimatedComponent>

        <AnimatedComponent name="animation-4" delay={0.15} duration={2} yDuration={2} translateY={50}>
          <div className={classNames('type-info')}>
            <div className={classNames('text-frame')}>
              <h3 className={classNames('txt-title')}>인천 에어포트 서비스</h3>
              <div className="category">
                <div
              ...
              <div className={classNames('text-content')}>
                <p className={classNames('txt-info')}>{getContentByButton(selectedButtonIncheon)}</p>
              </div>
            </div>
